    ...
    <div className="min-h-screen bg-[#f4f6f9]">
      ...
      <div className="lg:pl-[252px]">
        ...
        <main className="mx-auto max-w-[1800px] p-4 md:p-7 xl:p-8">
          <div className="mb-6"><div className="mb-2 text-sm text-slate-500">Главная <span className="mx-2">/</span> <span className="text-slate-800">Производство</span></div><h1 className="text-3xl font-bold tracking-tight text-slate-950">Производство</h1><p className="mt-1 text-slate-500">Контроль этапов изготовления памятников</p></div>
