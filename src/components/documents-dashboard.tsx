    ...
    <div className="min-h-screen bg-[#f4f6f9]">
      ...
      <div className="lg:pl-[252px]">
        ...
        <main className="mx-auto max-w-[1800px] p-4 md:p-7 xl:p-8">
          <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><div className="mb-2 text-sm text-slate-500">Главная <span className="mx-2">/</span> <span className="text-slate-800">Документы</span></div><h1 className="text-3xl font-bold text-slate-950">Документы</h1><p className="mt-1 text-slate-500">Формирование наряд-заказов, договоров, квитанций и актов</p></div><button className="btn-primary md:hidden" onClick={() => setModal(true)}><Plus className="h-4 w-4" />Сформировать документ</button></div>
